...
public class EstudanteController {
	...
	@PatchMapping("/{id}")
	public ResponseEntity atualizarEnderecoEstudante(@PathVariable Long id, @RequestBody Estudante estudante) {
		return estudanteService.atualizarEnderecoEstudante(id, estudante);
	}
